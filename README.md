...
4.	Output: Displays the result of the operation. If the user enters an invalid operation or attempts division by zero, an appropriate error message is shown.
Code Structure
